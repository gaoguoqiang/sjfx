...
E_D("replace into `phome_enewspubvar` values('1','sitetitle','网站简称','今日头条','网站简称','0','0','1');");
E_D("replace into `phome_enewspubvar` values('2','siteurl','网址地址','http://ceshi.codes99.com/','带http:// , 后边带斜杠 /','0','0','1');");
...
E_D("replace into `phome_enewspubvar` values('6','wapurl','手机版地址','http://m.ceshi.codes99.com','','0','0','1');");
E_D("replace into `phome_enewspubvar` values('7','ftitle','副标题','你关心的，才是头条！','','0','0','1');");
E_D("replace into `phome_enewspubvar` values('8','shorturl','不带http://的短域名','ceshi.codes99.com','前边不带http://，后边不带斜杠','0','0','1');");
