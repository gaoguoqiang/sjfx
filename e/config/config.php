...
//后台安全设置
$ecms_config['esafe']['loginauth']='w1234567890';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['ecookiernd']='liKfuas9bS3yZ9JqU9D94A7tsqe1pD';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='vehjm';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='ofzbb';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='8fOmI5TFDy3alxzIUCfGeR5v9H2sXy';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='3O260DarMm1vn5WEI23HOTQU9IlT0Q';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'modmemberedittran'=>1,
'modinfoedittran'=>1,
'deftempid'=>0,'add_sitetitle'=>'今日头条','add_siteurl'=>'http://ceshi.codes99.com/','add_beian'=>'京公网安备 11010802020116号','add_jubao'=>'xxx@xxx.com','add_tj'=>'统计代码填到这里','add_wapurl'=>'http://m.ceshi.codes99.com','add_ftitle'=>'你关心的，才是头条！','add_shorturl'=>'ceshi.codes99.com','add_changyanid'=>'prod_8d01521f822b32f1a30f058371f6eeef','add_changyan_client_id'=>'cys3T11v7');
//------------e_public
