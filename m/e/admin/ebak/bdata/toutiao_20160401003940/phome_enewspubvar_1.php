...
E_D("replace into `phome_enewspubvar` values('2','siteurl','网址地址','http://127.0.0.36','带http://','0','0','1');");
...
E_D("replace into `phome_enewspubvar` values('6','wapurl','手机版地址','http://127.0.0.37','','0','0','1');");
...
E_D("replace into `phome_enewspubvar` values('9','changyanid','搜狐畅言ID','prod_2c61c9f87cd630112e164bb7dd5d8e5e','如：prod_2c61c9f87cd630112e164bb7dd5d8e5e','0','0','1');");
E_D("replace into `phome_enewspubvar` values('10','cyappid','畅言appid','cys0Avatb','','0','0','1');");
